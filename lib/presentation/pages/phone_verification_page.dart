...
import 'package:whatsapp_clone/presentation/pages/set_inital_profile_page.dart';
            ...
            Expanded(
              child: Align(
                ...
                child: MaterialButton(
                  color: greenColor,
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>SetInitalProfilePage()));
                  },
                  child: Text(
                    "Next",
                    style: TextStyle(
